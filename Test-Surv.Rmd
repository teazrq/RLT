...
```{r class.source = NULL, fig.width=15, fig.height=25, out.width="90%"}
  ...
  start_time <- Sys.time()
  SurvBand = get.surv.band(RLTPred, alpha = alpha, method = "naive-mc")
  difftime(Sys.time(), start_time, units = "secs")
...
```{r class.source = NULL, fig.width=15, fig.height=25, out.width="90%"}
  # original Monte Carlo approach
  start_time <- Sys.time()
  SurvBand = get.surv.band(RLTPred, alpha = alpha, method = "smoothed-mc", nsim = 1000)
  difftime(Sys.time(), start_time, units = "secs")
...
```{r class.source = NULL, fig.width=15, fig.height=25, out.width="90%"}
  # original Monte Carlo approach
  start_time <- Sys.time()
  SurvBand = get.surv.band(RLTPred, alpha = alpha, method = "smoothed-nearpd", nsim = 1000)
  difftime(Sys.time(), start_time, units = "secs")
...
```{r class.source = NULL, fig.width=15, fig.height=25, out.width="90%"}
  # original Monte Carlo approach
  start_time <- Sys.time()
  SurvBand = get.surv.band(RLTPred, alpha = alpha, method = "smoothed-lr", r = 5)
  difftime(Sys.time(), start_time, units = "secs")
