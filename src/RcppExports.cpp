...
// ClaUniCombForestFit
List ClaUniCombForestFit(arma::mat& X, arma::uvec& Y, arma::uvec& Ncat, size_t nclass, arma::vec& obsweight, arma::vec& varweight, arma::imat& ObsTrack, List& param_r);
RcppExport SEXP _RLT_ClaUniCombForestFit(SEXP XSEXP, SEXP YSEXP, SEXP NcatSEXP, SEXP nclassSEXP, SEXP obsweightSEXP, SEXP varweightSEXP, SEXP ObsTrackSEXP, SEXP param_rSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(ClaUniCombForestFit(X, Y, Ncat, nclass, obsweight, varweight, ObsTrack, param_r));
    return rcpp_result_gen;
END_RCPP
}
// ClaUniCombForestPred
List ClaUniCombForestPred(arma::field<arma::ivec>& SplitVar, arma::field<arma::vec>& SplitValue, arma::field<arma::uvec>& LeftNode, arma::field<arma::uvec>& RightNode, arma::field<arma::vec>& NodeWeight, arma::field<arma::mat>& NodeProb, arma::mat& X, arma::uvec& Ncat, bool VarEst, bool keep_all, size_t usecores, size_t verbose);
RcppExport SEXP _RLT_ClaUniCombForestPred(SEXP SplitVarSEXP, SEXP SplitValueSEXP, SEXP LeftNodeSEXP, SEXP RightNodeSEXP, SEXP NodeWeightSEXP, SEXP NodeProbSEXP, SEXP XSEXP, SEXP NcatSEXP, SEXP VarEstSEXP, SEXP keep_allSEXP, SEXP usecoresSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(ClaUniCombForestPred(SplitVar, SplitValue, LeftNode, RightNode, NodeWeight, NodeProb, X, Ncat, VarEst, keep_all, usecores, verbose));
    return rcpp_result_gen;
END_RCPP
}
// ClaUniForestFit
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_RLT_ClaUniCombForestPred", (DL_FUNC) &_RLT_ClaUniCombForestPred, 12},
