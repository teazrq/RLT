...
// [[Rcpp::export()]]
List Kernel_Self_Comb(arma::field<arma::imat>& SplitVar,
...
// [[Rcpp::export()]]
List Kernel_Cross_Comb(arma::field<arma::imat>& SplitVar,
                       arma::field<arma::mat>& SplitLoad,
                       arma::field<arma::vec>& SplitValue,
                       arma::field<arma::uvec>& LeftNode,
                       arma::field<arma::uvec>& RightNode,
                       ...
                       size_t verbose)
{
  ...
  for (size_t nt = 0; nt < ntrees; nt++)
  {
    ...
    // get terminal node ids
    Find_Terminal_Node_Comb(0, OneTree, X1, Ncat, proxy_id1, real_id1, TermNode1);
    Find_Terminal_Node_Comb(0, OneTree, X2, Ncat, proxy_id2, real_id2, TermNode2);
...
// [[Rcpp::export()]]
List Kernel_Train_Comb(arma::field<arma::imat>& SplitVar,
                       arma::field<arma::mat>& SplitLoad,
                       arma::field<arma::vec>& SplitValue,
                       arma::field<arma::uvec>& LeftNode,
                       arma::field<arma::uvec>& RightNode,
